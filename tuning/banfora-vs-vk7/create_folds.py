...
data_path = '/home/eng/esrdfn/tuning/banfora-vs-vk7/final-data/'
results_path = '/home/eng/esrdfn/tuning/banfora-vs-vk7/results/'
...
window_overlap = [0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 5]
...
def run(window_size, overlap, train_trials, index):
    ...
    df_target.loc[df_target['TrialID'].isin([0,1,2,3]), 'Target'] = 1
    df_target.loc[df_target['TrialID'].isin([13,14,15,16]), 'Target'] = 0
