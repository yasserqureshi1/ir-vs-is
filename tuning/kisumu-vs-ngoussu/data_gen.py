...
path = '/home/eng/esrdfn/tuning/kisumu-vs-ngoussu/'

# Path to store dataframes
df_path = '/home/eng/esrdfn/tuning/kisumu-vs-ngoussu/dfs/'
...
hyp_trials = np.array([4,5, 9,10])
kisumu = np.array([4,5])
ngoussu = np.array([9,10])
...
if __name__ == '__main__':
    ...
    mask = np.isin(tracksTrialId, ngoussu)
    trackTargets[mask] = 0
    trackTargets[~mask] = 1
